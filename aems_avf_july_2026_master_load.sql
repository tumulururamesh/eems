...
INSERT INTO academic_year_master (academic_year, active_flag) SELECT '2026-2027', TRUE WHERE NOT EXISTS (SELECT 1 FROM academic_year_master WHERE academic_year='2026-2027');
...
JOIN academic_year_master ay ON ay.academic_year='2026-2027'
...
SELECT 'student_center_assignments_2026_27', COUNT(*) FROM student_center_assignment sca JOIN academic_year_master ay ON ay.academic_year_id=sca.academic_year_id WHERE ay.academic_year='2026-2027' UNION ALL
SELECT 'tutor_centre_assignments_2026_27', COUNT(*) FROM tutor_centre_assignment tca JOIN academic_year_master ay ON ay.academic_year_id=tca.academic_year_id WHERE ay.academic_year='2026-2027';
